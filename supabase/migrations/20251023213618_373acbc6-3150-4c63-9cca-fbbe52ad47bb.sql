-- Corregir search_path en las funciones recién creadas

DROP FUNCTION IF EXISTS validate_property_code(TEXT, UUID, UUID);
DROP FUNCTION IF EXISTS validate_contract_number(TEXT, UUID, UUID);

-- validate_property_code con search_path correcto
...
-- validate_contract_number con search_path correcto
