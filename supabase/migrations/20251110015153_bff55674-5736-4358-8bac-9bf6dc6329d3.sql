-- Actualizar función de cashflow para manejar reembolsos correctamente
-- Los reembolsos CON contrato son INGRESOS (el inquilino los paga)
-- Los reembolsos SIN contrato son GASTOS (la inmobiliaria/propietario los asume)
...
BEGIN
  ...
  -- Calcular gastos reembolsables con contrato (estos se agregan como ingresos porque el inquilino los paga)
  ...
  -- Calcular gastos: solo gastos NO reembolsables o sin contrato
  ...
  -- Los reembolsables se suman a los ingresos porque el inquilino los paga
...
-- Crear función similar para cuando se actualiza un gasto
...
'Actualiza el cashflow de la propiedad. Los gastos reembolsables con contrato se suman a los ingresos porque el inquilino los paga.';

COMMENT ON FUNCTION public.update_property_cashflow_on_expense() IS 
'Actualiza el cashflow cuando se registra/modifica un gasto. Maneja reembolsos como ingresos si tienen contrato asociado.';