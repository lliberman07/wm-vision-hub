-- Corregir la función usando paid_date en lugar de payment_date
...
BEGIN
  ...
  -- Insertar usando paid_date (columna correcta de pms_payment_submissions)
  INSERT INTO pms_payments (
    ...
    submission_id_param,
    submission_rec.paid_date,  -- Usar paid_date
    submission_rec.paid_date,  -- Usar paid_date
    effective_amount,
