...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // Email HTML content - different for reset vs new user
    let emailHtml;

    if (is_reset && password) {
      // Password recovery email with temporary password
      emailHtml = `
        <!DOCTYPE html>
        <html>
        <head>
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="credentials">
                <h3 style="margin: 0 0 15px 0;">Tu nueva contraseña temporal:</h3>
                <p style="margin: 8px 0;"><strong>Email:</strong> ${email}</p>
                <p style="margin: 8px 0;"><strong>Contraseña:</strong> <code style="background: white; padding: 4px 8px; border-radius: 3px; font-size: 14px; letter-spacing: 1px;">${password}</code></p>
              </div>
              
              <div class="warning-box">
                <p style="margin: 0;"><strong>⚠️ Importante:</strong> Por seguridad, te recomendamos cambiar esta contraseña temporal después de iniciar sesión.</p>
              </div>
              ...
              <div style="margin-top: 30px; padding-top: 25px; border-top: 1px solid #e0e0e0;">
                ...
                <p style="font-size: 14px; color: #666; margin: 5px 0;">Si no solicitaste este cambio de contraseña, contacta inmediatamente con soporte.</p>
              </div>
              
              <p style="margin-top: 30px;">Saludos cordiales,<br><strong>El equipo de Granada Platform</strong></p>
            </div>
            <div class="footer">
