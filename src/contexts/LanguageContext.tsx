...
const translations = {
  en: {
    ...
    'about.team.leadership.desc': 'Innovative industry leadership team with decades of combined experience in real estate management, applied technologies and investment.',
    ...
    'financing.program.benefits.noFees.desc': 'Transparent pricing with competitive setup costs',
    'financing.program.benefits.quickApproval': 'Quick Approval',
    'financing.program.benefits.quickApproval.desc': 'Streamlined process with fast decision making',
    'financing.program.benefits.flexible': 'Flexible Payments',
    'financing.program.benefits.flexible.desc': 'Customized payment schedules to fit your cash flow',
    'financing.program.features.interest': '0% Interest',
    'financing.program.features.interest.desc': 'On approved financing',
    'financing.program.features.terms': 'Flexible Terms',
    'financing.program.features.terms.desc': 'Up to 60 months',
    'financing.program.features.secure': 'Secure Process',
    'financing.program.features.secure.desc': 'Fast approval',
    'financing.program.features.coverage': '50% Coverage',
    'financing.program.features.coverage.desc': 'Of remodeling costs',
    ...
    'financing.signup.benefits.consultation': 'Personalized consultation',
    'financing.signup.benefits.solutions': 'Custom financing solutions',
    'financing.signup.benefits.guidance': 'Expert guidance throughout the process',
    ...
    'contact.form.messagePlaceholder': 'Tell us about your project or how we can help you...',
    'contact.form.send': 'Send Message',
    'contact.form.success': 'Message Sent!',
    'contact.form.successDesc': 'We\'ll get back to you within 48 hours.',
    'contact.form.validation.name': 'Please fill out this field.',
    'contact.form.validation.email': 'Please enter a valid email address.',
    'contact.form.validation.message': 'Please fill out this field.',
    'contact.info.title': 'Contact Information',
    'contact.info.subtitle': 'Our team is ready to provide clear, prompt assistance. Your success is our priority.',
    'contact.info.phone': 'Phone',
    'contact.info.phoneHours': 'Monday - Friday, 9:00 AM - 6:00 PM EST',
    ...
    'contact.info.hoursWeekday': 'Monday - Friday: 9:00 AM - 6:00 PM',
    'contact.info.hoursSaturday': 'Saturday: 10:00 AM - 4:00 PM',
    ...
    // Franchise Simulator translations
    'simulator.title': 'Franchise Investment Simulator',
    ...
    'simulator.tabs.basic': 'Basic Settings',
    'simulator.tabs.advanced': 'Advanced Settings',
    'simulator.tabs.results': 'Results & Analysis',
    'simulator.totalCost.title': 'Total Franchise Cost',
    'simulator.totalCost.description': 'Enter the overall investment required for the franchise',
    'simulator.totalCost.label': 'Total Cost ($)',
    'simulator.breakdown.title': 'Cost Breakdown Percentages',
    'simulator.breakdown.description': 'Adjust the allocation of your total investment',
    'simulator.breakdown.entranceFee': 'Entrance Fee',
    'simulator.breakdown.infrastructure': 'Infrastructure & Remodeling',
    ...
    'simulator.property.size': 'Local Size (m²)',
  ...
  es: {
    ...
    'about.team.leadership.desc': 'Equipo de Liderazgo innovador de la industria con décadas de experiencia combinada en gestión inmobiliaria, tecnologías aplicadas e inversión.',
    ...
    'industries.hero.title': 'Gestión de Propiedades en diversas Industrias',
    ...
    'financing.program.benefits.noFees.desc': 'Precios transparentes con costos de configuración competitivos',
    'financing.program.benefits.quickApproval': 'Aprobación Rápida',
    'financing.program.benefits.quickApproval.desc': 'Proceso simplificado con toma de decisiones rápida',
    'financing.program.benefits.flexible': 'Pagos Flexibles',
    'financing.program.benefits.flexible.desc': 'Horarios de pago personalizados para ajustarse a su flujo de efectivo',
    'financing.program.features.interest': '0% de Interés',
    'financing.program.features.interest.desc': 'En financiamiento aprobado',
    'financing.program.features.terms': 'Términos Flexibles',
    'financing.program.features.terms.desc': 'Hasta 60 meses',
    'financing.program.features.secure': 'Proceso Seguro',
    'financing.program.features.secure.desc': 'Aprobación rápida',
    'financing.program.features.coverage': '50% de Cobertura',
    'financing.program.features.coverage.desc': 'De los costos de remodelación',
    'financing.signup.benefits.consultation': 'Consulta personalizada',
    'financing.signup.benefits.solutions': 'Soluciones de financiamiento personalizadas',
    'financing.signup.benefits.guidance': 'Orientación experta durante todo el proceso',
    ...
    'contact.form.messagePlaceholder': 'Cuéntanos sobre tu proyecto o cómo podemos ayudarte...',
    'contact.form.send': 'Enviar Mensaje',
    'contact.form.success': '¡Mensaje Enviado!',
    'contact.form.successDesc': 'Te contactaremos en 48 horas.',
    'contact.form.validation.name': 'Por favor complete este campo.',
    'contact.form.validation.email': 'Por favor ingrese una dirección de email válida.',
    'contact.form.validation.message': 'Por favor complete este campo.',
    ...
    'contact.info.phoneHours': 'Lunes - Viernes, 9:00 AM - 6:00 PM EST',
    'contact.info.email': 'Email',
    'contact.info.emailResponse': 'Respondemos en 24 horas',
    'contact.info.address': 'Dirección de Oficina',
    'contact.info.hours': 'Horarios de Oficina',
    'contact.info.hoursWeekday': 'Lunes - Viernes: 9:00 AM - 6:00 PM',
    'contact.info.hoursSaturday': 'Sábado: 10:00 AM - 4:00 PM',
    ...
    // Franchise Simulator translations
    'simulator.title': 'Simulador de Inversión de Franquicia',
